<sidebar class="sidebar-wrapper">
    ...
    <?php if (!$this->data['username'] || $this->data['access_type'] == 0) : ?>
        <a href="/public/home" class="sidebar-link">
        ...
        <a href="/public/cart" class="sidebar-link">
        ...
        <a href="/public/checkout" class="sidebar-link">
        ...
        <?php if ($this->data['username']) : ?>
            <a href="#" id="log-out" class="sidebar-link log-out">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
                    <!--! Font Awesome Pro 6.2.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. -->
        ...
        <?php else : ?>
            <a href="/public/user/login" class="sidebar-link">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                    <!--! Font Awesome Pro 6.2.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. -->
            ...
            <a href="/public/user/register" class="sidebar-link">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
                    <!--! Font Awesome Pro 6.2.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. -->
        ...
        <?php endif; ?>
    <?php else : ?>
        <a href="/public/product/add" class="sidebar-link">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                <!--! Font Awesome Pro 6.2.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. -->
        ...
        <a href="/public/transaction" class="sidebar-link">
            <svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 576 512">
                <!--! Font Awesome Free 6.4.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
        ...
        <a href="/public/history" class="sidebar-link">
