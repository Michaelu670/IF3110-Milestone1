                ...
                <div class="wrapper">
                    <div class="leftbar-container">
                        ...
                        <div class="detail-container">
                            ...
                            <!-- Payment Method -->
                            <form class="payment-method" id="payment">
                            ...
                            <!-- Payment Details -->
                            <form class="payment-detail" id="payment-details">
                                <!-- E-WALLET DETAILS -->
                                <div class="detail" id="ewallet-detail">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <p id="ewallet-alert" class="ewallet-hide"></p>
                                    </div>
                                </div>
                                ...
                                <div class="detail" id="card-detail">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <p id="card-number-alert" class="card-number-hide"></p>
                                    </div>
                                    <div class="form-group">
                                        <label class="bold-text">Expiration Date</label>
                                        <input type="text" name="card-number" placeholder="mmyy" id="card-exp">
                                        <p id="card-exp-alert" class="card-exp-hide"></p>
                                    </div>
                                    <div class="form-group">
                                        <label class="bold-text">CVV</label>
                                        <input type="password" name="card-cvv" placeholder="123" id="card-cvv">
                                        <p id="card-cvv-alert" class="card-cvv-hide"></p>
                                    </div>
                                </div>
